...
from rest_framework3.compat import oauth2_provider, oauth2_provider_scope
from rest_framework3.compat import oauth, oauth_provider
from rest_framework3.test import APIRequestFactory, APIClient
...
urlpatterns = patterns(
    ...
    (r'^auth-token/$', 'rest_framework3.authtoken.views.obtain_auth_token'),
    ...
    url(r'^auth/', include('rest_framework3.urls', namespace='rest_framework'))
)
