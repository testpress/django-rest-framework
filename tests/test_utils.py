...
class ResolveModelWithPatchedDjangoTests(TestCase):
    ...
    def setUp(self):
        ...
        self.get_model = rest_framework3.utils.model_meta.models.get_model

        def get_model(app_label, model_name):
            return None

        rest_framework3.utils.model_meta.models.get_model = get_model

    def tearDown(self):
        """Revert monkeypatching."""
        rest_framework3.utils.model_meta.models.get_model = self.get_model
