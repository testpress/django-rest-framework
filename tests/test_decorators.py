...
from rest_framework3.authentication import BasicAuthentication
from rest_framework3.parsers import JSONParser
from rest_framework3.permissions import IsAuthenticated
from rest_framework3.response import Response
from rest_framework3.renderers import JSONRenderer
from rest_framework3.test import APIRequestFactory
from rest_framework3.throttling import UserRateThrottle
from rest_framework3.views import APIView
from rest_framework3.decorators import (
    api_view,
    renderer_classes,
    parser_classes,
