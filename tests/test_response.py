...
from rest_framework3 import generics
from rest_framework3 import routers
from rest_framework3 import serializers
from rest_framework3 import status
from rest_framework3.renderers import (
    BaseRenderer,
    JSONRenderer,
    BrowsableAPIRenderer
)
from rest_framework3 import viewsets
...
urlpatterns = patterns(
    ...
    url(r'^restframework', include('rest_framework3.urls', namespace='rest_framework'))
)
