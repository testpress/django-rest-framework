...
from rest_framework3 import serializers, viewsets, permissions
from rest_framework3.decorators import detail_route, list_route
from rest_framework3.response import Response
from rest_framework3.routers import SimpleRouter, DefaultRouter
